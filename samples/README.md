...
> IMPORTANT: You will need to perform a one-time setup to store the Azure GitHub package registry as source. This is only a requirement while we are in private preview.
